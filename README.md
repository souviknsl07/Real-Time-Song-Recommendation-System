...
This repository contains the implementation of a real-time song recommendation system leveraging **Apache Spark ML** for **collaborative filtering** and **content-based filtering**. The system ingests real-time user interaction data (e.g., song plays, likes) from a web or mobile application and delivers personalized song recommendations.

## 🧠 Features

- Simulation of Real-time data ingestion via AWS Lambda and Kinesis Data Streams
- Streaming pipeline using Amazon Kinesis Firehose and S3
- Scalable processing using Apache Spark Structured Streaming
- Pre-trained hybrid recommendation model (Collaborative + Content-based filtering) using Spark ML
...
## 🚀 How It Works
  ...
  - User Interaction: When a user plays a song or interacts with the app, the event is sent to AWS Lambda.
  ...
  - Cataloging & Querying: AWS Glue Crawlers scan the S3 data and create Athena tables for querying recommendations in near real-time.
